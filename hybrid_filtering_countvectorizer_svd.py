...
# Function to calculate genre percentage for a user
...
# Streamlit button to get hybrid recommendations
if st.button('Recommend Movies'):
    if selected_movie_id:
        ...
        if not hybrid_recommendations.empty:
            ...
            st.write(f"\nTop hybrid recommendations for user {user_id} and movie '{movie_title}':")
...
# Calculate and display genre percentage for the selected user when button is clicked
